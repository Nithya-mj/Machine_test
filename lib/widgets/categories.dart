                    ...
                    children: [
                        Stack(
                          ...
                          children: [
                            ...
                            FadeInImage.assetNetwork(placeholder: Const.placeholder, image: categoryItem.values?[index].imageUrl??'',
                              height: 40,width: 40,)
                          ],
                        ),
                      Expanded(child: Text(categoryItem.values?[index].name ?? '',style: const TextStyle(fontSize: 13,color: Colors.black),))
                    ],
                  ),
                );
              },
